...
export const getTransformHandles = (
  ...
  if (element.type === "freedraw" || isLinearElement(element)) {
    ...
    element.type === "puzzlePiece" ||
    element.type === "puzzlePiece2" ||
    element.type === "puzzlePiece3"
  ) {
    // Puzzle pieces are fixed-size: omit all resize handles, but keep rotation
    omitSides = {
      e: true,
      w: true,
      n: true,
