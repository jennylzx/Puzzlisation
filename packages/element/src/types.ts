...
export type ExcalidrawPuzzlePieceElement = _ExcalidrawElementBase & {
  type: "puzzlePiece";
};

export type ExcalidrawPuzzlePiece2Element = _ExcalidrawElementBase & {
  type: "puzzlePiece2";
};

export type ExcalidrawPuzzlePiece3Element = _ExcalidrawElementBase & {
  type: "puzzlePiece3";
};
...
export type ExcalidrawGenericElement =
  ...
  | ExcalidrawPuzzlePieceElement
  | ExcalidrawPuzzlePiece2Element
  | ExcalidrawPuzzlePiece3Element;
