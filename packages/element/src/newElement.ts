...
const _newElementBase = <T extends ExcalidrawElement>(
  ...
  // Enforce fixed dimensions for puzzle pieces at the beginning
  if (type === "puzzlePiece") {
    width = PUZZLE_SIZES_PX.A.width;
    height = PUZZLE_SIZES_PX.A.height;
  } else if (type === "puzzlePiece2") {
    width = PUZZLE_SIZES_PX.B.width;
    height = PUZZLE_SIZES_PX.B.height;
  } else if (type === "puzzlePiece3") {
    width = PUZZLE_SIZES_PX.C.width;
    height = PUZZLE_SIZES_PX.C.height;
  }
