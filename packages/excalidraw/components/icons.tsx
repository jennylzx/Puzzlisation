...
// Puzzle piece A icon — outline version, derived from the actual puzzle SVG path, scaled to 24×24
export const PuzzlePieceIcon = createIcon(
  <g strokeWidth="1.25" stroke="currentColor" fill="none">
    <path d="M11.09 3.86c.93-.31 2.3-.54 3.9-.62.52-.03.83.6.48.99l-.03.04c-.47.47-.48 1.23-.01 1.7.46.47 1.22.46 1.7-.01.47-.47.48-1.23.01-1.7v-.01c-.38-.38-.08-1.04.45-1.01 1.62.08 3.02.3 3.95.62-.32.94-.54 2.34-.62 3.95-.03.54.63.84 1.01.46l.01-.01c.47-.46 1.22-.46 1.7.01.47.47.48 1.23.01 1.7s-1.22.46-1.7-.01l-.04-.03c-.39-.36-.99-.05-.99.48.08 1.6.3 2.98.62 3.9-.93.31-2.31.54-3.9.62-.53.03-.84-.6-.49-.99l.04-.04c.47-.47.48-1.23.01-1.7-.46-.46-1.22-.46-1.7.01-.47.48-.48 1.23-.01 1.7h.01c.38.39.08 1.04-.46 1.02-1.62-.08-3.02-.3-3.95-.62-.94-.32-2.33-.54-3.95-.62-.54-.03-.83.63-.46 1.01l.01.01c.46.46.46 1.22-.01 1.7-.47.47-1.23.48-1.7.01-.46-.47-.46-1.22.01-1.7l.04-.04c.36-.39.04-1.01-.49-.99-1.6.08-2.98.3-3.91.62-.17-.95-.39-2.35-.48-3.97-.03-.52.6-.83.99-.48l.04.03c.47.47 1.23.47 1.7.01.47-.47.46-1.22-.01-1.7-.47-.47-1.23-.47-1.7-.01v.01c-.39.38-1.04.08-1.02-.46.08-1.62.3-3.02.62-3.95.94.32 2.33.54 3.95.62.54.03.84-.63.46-1.01 0 0 0 0-.01-.01-.47-.46-.46-1.22.01-1.7.47-.47 1.23-.48 1.7-.01.47.46.46 1.22-.01 1.7l-.04.04c-.36.39-.04 1.01.49.99 1.6-.08 2.98-.3 3.91-.62Z" />
  </g>,
  { width: 24, height: 24 },
);

// Puzzle piece B icon — outline version, derived from the actual puzzle SVG path, scaled to 24×24
export const PuzzlePiece2Icon = createIcon(
  <g strokeWidth="1.25" stroke="currentColor" fill="none">
    <path d="M2.3 12c-.29-.86-.5-2.14-.57-3.62-.03-.49.55-.78.92-.45l.04.03c.44.44 1.14.44 1.57.01.43-.43.43-1.13-.01-1.57-.44-.44-1.14-.44-1.57-.01 0 0 0 0-.01.01-.36.35-.96.07-.94-.43.07-1.5.28-2.8.58-3.67.87.29 2.17.5 3.67.58.5.03.78-.58.43-.94 0 0-.01 0-.01-.01-.43-.43-.43-1.13.01-1.57.44-.44 1.14-.44 1.57-.01.43.43.43 1.13-.01 1.57l-.03.04c-.33.36-.04.94.45.92 1.48-.07 2.76-.28 3.62-.57.86-.29 2.14-.5 3.62-.57.49-.03.77.55.45.92l-.03.04c-.44.44-.44 1.14-.01 1.57.43.43 1.13.43 1.57-.01.44-.44.44-1.14.01-1.57 0 0-.01 0-.01-.01-.35-.36-.07-.96.42-.94 1.5.07 2.8.28 3.67.58-.29.87-.5 2.17-.58 3.67-.03.5.58.78.94.43v-.01c.44-.43 1.14-.43 1.58.01.44.44.44 1.14.01 1.57-.43.43-1.13.43-1.57-.01l-.04-.03c-.36-.33-.94-.04-.92.45.08 1.48.28 2.76.57 3.62.29.86.5 2.14.57 3.62.03.49-.55.77-.92.45l-.04-.03c-.44-.44-1.14-.44-1.57-.01-.43.43-.42 1.13.01 1.57.44.44 1.14.44 1.57.01h.01c.36-.35.96-.07.94.42-.07 1.5-.28 2.8-.58 3.67-.87-.29-2.17-.5-3.67-.58-.5-.03-.78.58-.42.94h0c.43.44.42 1.14-.01 1.58-.44.44-1.14.44-1.57.01-.43-.43-.42-1.13.01-1.57l.03-.04c.33-.36.04-.94-.45-.92-1.48.07-2.76.28-3.62.57-.86.29-2.14.5-3.62.57-.49.03-.78-.55-.45-.92l.03-.04c.44-.44.44-1.14.01-1.57-.43-.43-1.13-.43-1.57.01-.44.44-.44 1.14-.01 1.57 0 0 0 .01.01.01.35.36.07.96-.43.94-1.5-.07-2.8-.28-3.67-.58.29-.87.5-2.17.58-3.67.03-.5-.58-.78-.94-.42 0 0-.01 0-.01.01-.43.43-1.13.42-1.57-.01-.44-.44-.44-1.14-.01-1.57.43-.43 1.13-.42 1.57.01l.04.03c.37.33.94.04.92-.45-.07-1.48-.28-2.76-.57-3.62Z" />
  </g>,
  { width: 24, height: 24 },
);

// Puzzle piece C icon — outline version, derived from the actual puzzle SVG path, scaled to 24×24
export const PuzzlePiece3Icon = createIcon(
  <g strokeWidth="1.25" stroke="currentColor" fill="none" transform="translate(2, 1.4) scale(0.7)">
    <path d="M3.29 5.84c-.64 1.93-1.09 4.8-1.27 8.12-.04 1.09 1.29 1.72 2.06.94h0c.94-.94 2.51-.94 3.48.02.97.97.99 2.53.02 3.48-.94.94-2.51.94-3.48-.02-.02-.02-.04-.04-.09-.06-.79-.73-2.08-.09-2.02.99.17 3.26.62 6.1 1.27 8.01 1.91-.64 4.74-1.09 8.01-1.27 1.07-.06 1.72 1.22.99 2.02-.02.02-.04.04-.06.09-.97.97-.97 2.53-.02 3.48.94.94 2.51.94 3.48-.02.97-.97.99-2.53.02-3.48h0c-.77-.79-.15-2.13.94-2.06 3.31.17 6.18.62 8.12 1.27.64-1.93 1.12-4.79 1.27-8.12.04-1.09-1.29-1.72-2.06-.94h0c-.94.97-2.51.97-3.48 0-.97-.97-.99-2.53-.02-3.48.94-.94 2.51-.94 3.48.02.02.02.04.04.09.06.79.73 2.08.09 2.02-.99-.17-3.26-.62-6.1-1.27-8.01-1.91.64-4.74 1.09-8.01 1.27-1.07.06-1.72-1.22-.99-2.02.02-.02.04-.04.06-.09.97-.97.97-2.53.02-3.48-.94-.94-2.51-.94-3.48.02-.97.97-.97 2.51-.02 3.48h0c.77.79.15 2.13-.94 2.06-3.31-.17-6.18-.62-8.12-1.27Z" />
  </g>,
  { width: 24, height: 24 },
);
